...
using EmailServiceImpl = eCommerce.EmailService.Services.EmailService;
...
namespace eCommerce.EmailService.Messaging
{
    public class AzureServiceBusConsumer : IAzureServiceBusConsumer
    {
        ...
        public AzureServiceBusConsumer(IConfiguration configuration, EmailServiceImpl emailService)
        {
